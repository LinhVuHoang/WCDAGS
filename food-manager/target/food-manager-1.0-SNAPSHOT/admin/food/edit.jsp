...
<head>
    <jsp:include page="/admin/include/header.jsp">
        <jsp:param name="title" value="Update Food form"/>
        <jsp:param name="description" value="Update Food form"/>
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
    ...
    <span class="w3-bar-item w3-right">Update Food Form</span>
</div>
    ...
    <div class="w3-row-padding w3-margin-bottom">
        <form action="" method="post" class="w3-container">
            ...
            <div class="w3-margin">
                ...
                <input class="w3-input" value="<%=food.getDaysell()%>" name="daysell" type="date" readonly>
                <br>
